  ...
  $.fn.twentytwenty = function (options) {
    ...
    return this.each(function () {
      ...
      var onMove = function (e) {
        ...
        let space = Number(
            document
              .querySelector(".twentytwenty-handle")
              .attributes[1].value.split(" ")[1]
              .split("p")[0]
          ),
          carNameRight = document.querySelector(".right-carname-comparison"),
          carNameLeft = document.querySelector(".left-carname-comparison");

        if (space >= carNameRight.offsetLeft) {
          carNameRight.style.color = "transparent";
        } else {
          carNameRight.style.color = "white";
        }

        if (space <= carNameLeft.offsetLeft) {
          carNameLeft.style.color = "transparent";
        } else {
          carNameLeft.style.color = "white";
        }
      };
